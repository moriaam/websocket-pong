      ...
      if (game_started) {
        if (right) {
          if (ball_position.x < 470) {
            ...
            if (
              (ball_position.y > guard_postition.right.y + guard_height_px ||
                ball_position.y < guard_postition.right.y) &&
              ball_position.x >= 470
            ) {
            ...
            if (ball_position.y <= 0) vertical_direction = 'down'
            else if (ball_position.y >= 272) vertical_direction = 'up'
          } else right = false
        } else if (!right) {
          if (ball_position.x > 26) {
            ...
            if (
              (ball_position.y > guard_postition.left.y + guard_height_px ||
                ball_position.y < guard_postition.left.y) &&
              ball_position.x <= 26
            ) {
